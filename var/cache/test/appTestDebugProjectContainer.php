...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pa.admin.dependent_candidate' => 'getPa_Admin_DependentCandidateService',
            'pa.admin.independent_candidate' => 'getPa_Admin_IndependentCandidateService',
            'pa.admin.pa_complaint' => 'getPa_Admin_PaComplaintService',
            'pa.admin.pa_foot_print' => 'getPa_Admin_PaFootPrintService',
            'pa.admin.pa_notification' => 'getPa_Admin_PaNotificationService',
            'pa.admin.pa_party' => 'getPa_Admin_PaPartyService',
            'pa.admin.pa_pink_sheet' => 'getPa_Admin_PaPinkSheetService',
            'pa.admin.pa_vote_cast' => 'getPa_Admin_PaVoteCastService',
            'pr.admin.pr_complaint' => 'getPr_Admin_PrComplaintService',
            'pr.admin.pr_foot_print' => 'getPr_Admin_PrFootPrintService',
            'pr.admin.pr_notification' => 'getPr_Admin_PrNotificationService',
            'pr.admin.pr_party' => 'getPr_Admin_PrPartyService',
            'pr.admin.pr_pink_sheet' => 'getPr_Admin_PrPinkSheetService',
            'pr.admin.pr_vote_cast' => 'getPr_Admin_PrVoteCastService',
            ...
            'user.admin.user' => 'getUser_Admin_UserService',
            'user.admin_form_filter' => 'getUser_AdminFormFilterService',
            'user.admin_show_filter' => 'getUser_AdminShowFilterService',
            ...
            'vtally.admin.collation_center' => 'getVtally_Admin_CollationCenterService',
            'vtally.admin.constituency' => 'getVtally_Admin_ConstituencyService',
            'vtally.admin.polling_station' => 'getVtally_Admin_PollingStationService',
            'vtally.admin.region' => 'getVtally_Admin_RegionService',
            'vtally.admin.returning_officer' => 'getVtally_Admin_ReturningOfficerService',
            'vtally.admin.setting' => 'getVtally_Admin_SettingService',
            'vtally.statistic_handler' => 'getVtally_StatisticHandlerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('sonata.admin.event.configure.show', array(0 => 'user.admin_show_filter', 1 => 'sonataAdminCheckUserRights'), 0);
        $instance->addListenerService('sonata.admin.event.configure.form', array(0 => 'user.admin_form_filter', 1 => 'sonataAdminCheckUserRights'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vtally2_test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/VtallyBundle/Entity'), 1 => ($this->targetDirs[3].'/src/PrBundle/Entity'), 2 => ($this->targetDirs[3].'/src/PaBundle/Entity'), 3 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'VtallyBundle\\Entity');
        $c->addDriver($b, 'PrBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('VtallyBundle' => 'VtallyBundle\\Entity', 'PrBundle' => 'PrBundle\\Entity', 'PaBundle' => 'PaBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2e3913146e5f04dbcc05920a5e5ce58292ff4b7b5b72715b0a7e1ad20db6cc04');
    ...
    {
        return $this->services['hautelook_alice.doctrine.orm.fixtures_finder'] = new \Hautelook\AliceBundle\Doctrine\Finder\FixturesFinder('DataFixtures/ORM');
    }
    ...
    /**
     * Gets the 'pa.admin.dependent_candidate' service.
     *
     * @return \PaBundle\Admin\DependentCandidateAdmin A PaBundle\Admin\DependentCandidateAdmin instance.
     */
    protected function getPa_Admin_DependentCandidateService()
    {
        $instance = new \PaBundle\Admin\DependentCandidateAdmin('pa.admin.dependent_candidate', 'PaBundle\\Entity\\DependentCandidate', 'PaBundle:DependentCandidateAdmin');
        ...
        $instance->setLabel('Dependent Candidate');
    ...
    /**
     * Gets the 'pa.admin.independent_candidate' service.
     *
     * @return \PaBundle\Admin\IndependentCandidateAdmin A PaBundle\Admin\IndependentCandidateAdmin instance.
     */
    protected function getPa_Admin_IndependentCandidateService()
    {
        $instance = new \PaBundle\Admin\IndependentCandidateAdmin('pa.admin.independent_candidate', 'PaBundle\\Entity\\IndependentCandidate', 'PaBundle:IndependentCandidateAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('Independent Candidate');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'SonataAdminBundle:Menu:sonata_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'pa.admin.pa_complaint' service.
     *
     * @return \PaBundle\Admin\PaComplaintAdmin A PaBundle\Admin\PaComplaintAdmin instance.
     */
    protected function getPa_Admin_PaComplaintService()
    {
        $instance = new \PaBundle\Admin\PaComplaintAdmin('pa.admin.pa_complaint', 'PaBundle\\Entity\\PaComplaint', 'PaBundle:PaComplaintAdmin');
    ...
    /**
     * Gets the 'pa.admin.pa_foot_print' service.
     *
     * @return \PaBundle\Admin\PaFootPrintAdmin A PaBundle\Admin\PaFootPrintAdmin instance.
     */
    protected function getPa_Admin_PaFootPrintService()
    {
        $instance = new \PaBundle\Admin\PaFootPrintAdmin('pa.admin.pa_foot_print', 'PaBundle\\Entity\\PaFootPrint', 'PaBundle:PaFootPrintAdmin');
    ...
    /**
     * Gets the 'pa.admin.pa_notification' service.
     *
     * @return \PaBundle\Admin\PaNotificationAdmin A PaBundle\Admin\PaNotificationAdmin instance.
     */
    protected function getPa_Admin_PaNotificationService()
    {
        $instance = new \PaBundle\Admin\PaNotificationAdmin('pa.admin.pa_notification', 'PaBundle\\Entity\\PaNotification', 'PaBundle:PaNotificationAdmin');
    ...
    /**
     * Gets the 'pa.admin.pa_party' service.
     *
     * @return \PaBundle\Admin\PaPartyAdmin A PaBundle\Admin\PaPartyAdmin instance.
     */
    protected function getPa_Admin_PaPartyService()
    {
        $instance = new \PaBundle\Admin\PaPartyAdmin('pa.admin.pa_party', 'PaBundle\\Entity\\PaParty', 'PaBundle:PaPartyAdmin');
    ...
    /**
     * Gets the 'pa.admin.pa_pink_sheet' service.
     *
     * @return \PaBundle\Admin\PaPinkSheetAdmin A PaBundle\Admin\PaPinkSheetAdmin instance.
     */
    protected function getPa_Admin_PaPinkSheetService()
    {
        $instance = new \PaBundle\Admin\PaPinkSheetAdmin('pa.admin.pa_pink_sheet', 'PaBundle\\Entity\\PaPinkSheet', 'PaBundle:PaPinkSheetAdmin');
    ...
    /**
     * Gets the 'pa.admin.pa_vote_cast' service.
     *
     * @return \PaBundle\Admin\PaVoteCastAdmin A PaBundle\Admin\PaVoteCastAdmin instance.
     */
    protected function getPa_Admin_PaVoteCastService()
    {
        $instance = new \PaBundle\Admin\PaVoteCastAdmin('pa.admin.pa_vote_cast', 'PaBundle\\Entity\\PaVoteCast', 'PaBundle:PaVoteCastAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_complaint' service.
     *
     * @return \PrBundle\Admin\PrComplaintAdmin A PrBundle\Admin\PrComplaintAdmin instance.
     */
    protected function getPr_Admin_PrComplaintService()
    {
        $instance = new \PrBundle\Admin\PrComplaintAdmin('pr.admin.pr_complaint', 'PrBundle\\Entity\\PrComplaint', 'PrBundle:PrComplaintAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_foot_print' service.
     *
     * @return \PrBundle\Admin\PrFootPrintAdmin A PrBundle\Admin\PrFootPrintAdmin instance.
     */
    protected function getPr_Admin_PrFootPrintService()
    {
        $instance = new \PrBundle\Admin\PrFootPrintAdmin('pr.admin.pr_foot_print', 'PrBundle\\Entity\\PrFootPrint', 'PrBundle:PrFootPrintAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_notification' service.
     *
     * @return \PrBundle\Admin\PrNotificationAdmin A PrBundle\Admin\PrNotificationAdmin instance.
     */
    protected function getPr_Admin_PrNotificationService()
    {
        $instance = new \PrBundle\Admin\PrNotificationAdmin('pr.admin.pr_notification', 'PrBundle\\Entity\\PrNotification', 'PrBundle:PrNotificationAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_party' service.
     *
     * @return \PrBundle\Admin\PrPartyAdmin A PrBundle\Admin\PrPartyAdmin instance.
     */
    protected function getPr_Admin_PrPartyService()
    {
        $instance = new \PrBundle\Admin\PrPartyAdmin('pr.admin.pr_party', 'PrBundle\\Entity\\PrParty', 'PrBundle:PrPartyAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_pink_sheet' service.
     *
     * @return \PrBundle\Admin\PrPinkSheetAdmin A PrBundle\Admin\PrPinkSheetAdmin instance.
     */
    protected function getPr_Admin_PrPinkSheetService()
    {
        $instance = new \PrBundle\Admin\PrPinkSheetAdmin('pr.admin.pr_pink_sheet', 'PrBundle\\Entity\\PrPinkSheet', 'PrBundle:PrPinkSheetAdmin');
    ...
    /**
     * Gets the 'pr.admin.pr_vote_cast' service.
     *
     * @return \PrBundle\Admin\PrVoteCastAdmin A PrBundle\Admin\PrVoteCastAdmin instance.
     */
    protected function getPr_Admin_PrVoteCastService()
    {
        $instance = new \PrBundle\Admin\PrVoteCastAdmin('pr.admin.pr_vote_cast', 'PrBundle\\Entity\\PrVoteCast', 'PrBundle:PrVoteCastAdmin');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('default_target_path' => '/admin', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'VTALLY2', 'images/logo.png', array('html5_validate' => true, 'sort_admins' => false, 'confirm_exit' => true, 'use_select2' => true, 'use_icheck' => true, 'use_bootlint' => false, 'use_stickyforms' => true, 'pager_links' => NULL, 'form_type' => 'standard', 'dropdown_number_groups_per_colums' => 2, 'title_mode' => 'both', 'lock_protection' => false, 'javascripts' => array(0 => 'bundles/sonatacore/vendor/jquery/dist/jquery.min.js', 1 => 'bundles/sonataadmin/vendor/jquery.scrollTo/jquery.scrollTo.min.js', 2 => 'bundles/sonatacore/vendor/moment/min/moment.min.js', 3 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/jquery-ui.min.js', 4 => 'bundles/sonataadmin/vendor/jqueryui/ui/minified/i18n/jquery-ui-i18n.min.js', 5 => 'bundles/sonatacore/vendor/bootstrap/dist/js/bootstrap.min.js', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js', 7 => 'bundles/sonataadmin/vendor/jquery-form/jquery.form.js', 8 => 'bundles/sonataadmin/jquery/jquery.confirmExit.js', 9 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js', 10 => 'bundles/sonatacore/vendor/select2/select2.min.js', 11 => 'bundles/sonataadmin/vendor/admin-lte/dist/js/app.min.js', 12 => 'bundles/sonataadmin/vendor/iCheck/icheck.min.js', 13 => 'bundles/sonataadmin/vendor/slimScroll/jquery.slimscroll.min.js', 14 => 'bundles/sonataadmin/vendor/waypoints/lib/jquery.waypoints.min.js', 15 => 'bundles/sonataadmin/vendor/waypoints/lib/shortcuts/sticky.min.js', 16 => 'bundles/sonataadmin/Admin.js', 17 => 'bundles/sonataadmin/treeview.js'), 'stylesheets' => array(0 => 'bundles/sonatacore/vendor/bootstrap/dist/css/bootstrap.min.css', 1 => 'bundles/sonatacore/vendor/components-font-awesome/css/font-awesome.min.css', 2 => 'bundles/sonatacore/vendor/ionicons/css/ionicons.min.css', 3 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/AdminLTE.min.css', 4 => 'bundles/sonataadmin/vendor/admin-lte/dist/css/skins/skin-black.min.css', 5 => 'bundles/sonataadmin/vendor/iCheck/skins/square/blue.css', 6 => 'bundles/sonatacore/vendor/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css', 7 => 'bundles/sonataadmin/vendor/jqueryui/themes/base/jquery-ui.css', 8 => 'bundles/sonatacore/vendor/select2/select2.css', 9 => 'bundles/sonatacore/vendor/select2-bootstrap-css/select2-bootstrap.min.css', 10 => 'bundles/sonataadmin/vendor/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css', 11 => 'bundles/sonataadmin/css/styles.css', 12 => 'bundles/sonataadmin/css/layout.css', 13 => 'bundles/sonataadmin/css/tree.css')), $this->get('property_accessor'));
        ...
        $instance->setAdminServiceIds(array(0 => 'vtally.admin.constituency', 1 => 'vtally.admin.collation_center', 2 => 'vtally.admin.polling_station', 3 => 'vtally.admin.region', 4 => 'vtally.admin.setting', 5 => 'vtally.admin.returning_officer', 6 => 'pr.admin.pr_vote_cast', 7 => 'pr.admin.pr_pink_sheet', 8 => 'pr.admin.pr_party', 9 => 'pr.admin.pr_notification', 10 => 'pr.admin.pr_complaint', 11 => 'pr.admin.pr_foot_print', 12 => 'pa.admin.pa_complaint', 13 => 'pa.admin.pa_vote_cast', 14 => 'pa.admin.pa_party', 15 => 'pa.admin.pa_foot_print', 16 => 'pa.admin.pa_notification', 17 => 'pa.admin.pa_pink_sheet', 18 => 'pa.admin.independent_candidate', 19 => 'pa.admin.dependent_candidate', 20 => 'user.admin.user'));
        $instance->setAdminGroups(array('Default' => array('label' => 'Default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'vtally.admin.constituency', 'label' => 'Constituency', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'vtally.admin.collation_center', 'label' => 'CollationCenter', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'vtally.admin.polling_station', 'label' => 'PollingStation', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'vtally.admin.region', 'label' => 'Region', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'vtally.admin.setting', 'label' => 'Setting', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'vtally.admin.returning_officer', 'label' => 'Returning Officer', 'route' => '', 'route_params' => array()))), 'Presidential' => array('label' => 'Presidential', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'pr.admin.pr_vote_cast', 'label' => 'Vote Cast', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'pr.admin.pr_pink_sheet', 'label' => 'Pink Sheet', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'pr.admin.pr_party', 'label' => 'Party', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'pr.admin.pr_notification', 'label' => 'Notification', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'pr.admin.pr_complaint', 'label' => 'Complaint', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'pr.admin.pr_foot_print', 'label' => 'Foot Print', 'route' => '', 'route_params' => array()))), 'Parliamentary' => array('label' => 'Parliamentary', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'pa.admin.pa_complaint', 'label' => 'Complaint', 'route' => '', 'route_params' => array()), 1 => array('admin' => 'pa.admin.pa_vote_cast', 'label' => 'Vote Cast', 'route' => '', 'route_params' => array()), 2 => array('admin' => 'pa.admin.pa_party', 'label' => 'Party', 'route' => '', 'route_params' => array()), 3 => array('admin' => 'pa.admin.pa_foot_print', 'label' => 'Foot Print', 'route' => '', 'route_params' => array()), 4 => array('admin' => 'pa.admin.pa_notification', 'label' => 'Notification', 'route' => '', 'route_params' => array()), 5 => array('admin' => 'pa.admin.pa_pink_sheet', 'label' => 'Pink Sheet', 'route' => '', 'route_params' => array()), 6 => array('admin' => 'pa.admin.independent_candidate', 'label' => 'Independent Candidate', 'route' => '', 'route_params' => array()), 7 => array('admin' => 'pa.admin.dependent_candidate', 'label' => 'Dependent Candidate', 'route' => '', 'route_params' => array()))), 'User / Security' => array('label' => 'User / Security', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => array('admin' => 'user.admin.user', 'label' => 'User', 'route' => '', 'route_params' => array())))));
        $instance->setAdminClasses(array('VtallyBundle\\Entity\\Constituency' => array(0 => 'vtally.admin.constituency'), 'VtallyBundle\\Entity\\CollationCenter' => array(0 => 'vtally.admin.collation_center'), 'VtallyBundle\\Entity\\PollingStation' => array(0 => 'vtally.admin.polling_station'), 'VtallyBundle\\Entity\\Region' => array(0 => 'vtally.admin.region'), 'VtallyBundle\\Entity\\Setting' => array(0 => 'vtally.admin.setting'), 'VtallyBundle\\Entity\\ReturningOfficer' => array(0 => 'vtally.admin.returning_officer'), 'PrBundle\\Entity\\PrVoteCast' => array(0 => 'pr.admin.pr_vote_cast'), 'PrBundle\\Entity\\PrPinkSheet' => array(0 => 'pr.admin.pr_pink_sheet'), 'PrBundle\\Entity\\PrParty' => array(0 => 'pr.admin.pr_party'), 'PrBundle\\Entity\\PrNotification' => array(0 => 'pr.admin.pr_notification'), 'PrBundle\\Entity\\PrComplaint' => array(0 => 'pr.admin.pr_complaint'), 'PrBundle\\Entity\\PrFootPrint' => array(0 => 'pr.admin.pr_foot_print'), 'PaBundle\\Entity\\PaComplaint' => array(0 => 'pa.admin.pa_complaint'), 'PaBundle\\Entity\\PaVoteCast' => array(0 => 'pa.admin.pa_vote_cast'), 'PaBundle\\Entity\\PaParty' => array(0 => 'pa.admin.pa_party'), 'PaBundle\\Entity\\PaFootPrint' => array(0 => 'pa.admin.pa_foot_print'), 'PaBundle\\Entity\\PaNotification' => array(0 => 'pa.admin.pa_notification'), 'PaBundle\\Entity\\PaPinkSheet' => array(0 => 'pa.admin.pa_pink_sheet'), 'PaBundle\\Entity\\IndependentCandidate' => array(0 => 'pa.admin.independent_candidate'), 'PaBundle\\Entity\\DependentCandidate' => array(0 => 'pa.admin.dependent_candidate'), 'UserBundle\\Entity\\User' => array(0 => 'user.admin.user')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'vtally.admin.constituency', 1 => 'vtally.admin.collation_center', 2 => 'vtally.admin.polling_station', 3 => 'vtally.admin.region', 4 => 'vtally.admin.setting', 5 => 'vtally.admin.returning_officer', 6 => 'pr.admin.pr_vote_cast', 7 => 'pr.admin.pr_pink_sheet', 8 => 'pr.admin.pr_party', 9 => 'pr.admin.pr_notification', 10 => 'pr.admin.pr_complaint', 11 => 'pr.admin.pr_foot_print', 12 => 'pa.admin.pa_complaint', 13 => 'pa.admin.pa_vote_cast', 14 => 'pa.admin.pa_party', 15 => 'pa.admin.pa_foot_print', 16 => 'pa.admin.pa_notification', 17 => 'pa.admin.pa_pink_sheet', 18 => 'pa.admin.independent_candidate', 19 => 'pa.admin.dependent_candidate', 20 => 'user.admin.user'), $this);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lb.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lb.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.zh_CN.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.zh_CN.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ro.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ro.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fr.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/translations/SonataBlockBundle.fr.xliff'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fr.xliff'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sk.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sk.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.eu.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.eu.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ca.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ca.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fi.xliff'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.bg.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.bg.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.nl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.nl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hr.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hr.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.it.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.it.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lt.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lt.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fa.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fa.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.es.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.es.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.de.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/translations/SonataBlockBundle.de.xliff'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.de.xliff'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.no.xliff')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ja.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ja.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ru.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ru.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ar.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ar.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.uk.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.uk.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hu.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/translations/SonataBlockBundle.hu.xliff'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hu.xliff'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt_BR.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt_BR.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.en.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/translations/SonataBlockBundle.en.xliff'), 5 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.en.xliff'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 7 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.cs.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.cs.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')), 'sv_SE' => array(0 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sv_SE.xliff')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')))), array());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/VtallyBundle/Resources/views'), 'Vtally');
        $instance->addPath(($this->targetDirs[3].'/src/PrBundle/Resources/views'), 'Pr');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cffb392d8bf4a86b9b1b8430fade19b873ad6971');
    }

    /**
     * Gets the 'user.admin.user' service.
     *
     * @return \UserBundle\Admin\UserAdmin A UserBundle\Admin\UserAdmin instance.
     */
    protected function getUser_Admin_UserService()
    {
        $instance = new \UserBundle\Admin\UserAdmin('user.admin.user', 'UserBundle\\Entity\\User', 'UserBundle:UserAdmin', $this->get('fos_user.user_manager'));
    ...
    /**
     * Gets the 'user.admin_form_filter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Event\UserCustomAction A UserBundle\Event\UserCustomAction instance.
     */
    protected function getUser_AdminFormFilterService()
    {
        return $this->services['user.admin_form_filter'] = new \UserBundle\Event\UserCustomAction();
    }

    /**
     * Gets the 'user.admin_show_filter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Event\UserCustomAction A UserBundle\Event\UserCustomAction instance.
     */
    protected function getUser_AdminShowFilterService()
    {
        return $this->services['user.admin_show_filter'] = new \UserBundle\Event\UserCustomAction();
    }
    ...
    /**
     * Gets the 'vtally.admin.collation_center' service.
     *
     * @return \VtallyBundle\Admin\CollationCenterAdmin A VtallyBundle\Admin\CollationCenterAdmin instance.
     */
    protected function getVtally_Admin_CollationCenterService()
    {
        $instance = new \VtallyBundle\Admin\CollationCenterAdmin('vtally.admin.collation_center', 'VtallyBundle\\Entity\\CollationCenter', 'VtallyBundle:CollationCenterAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('CollationCenter');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'SonataAdminBundle:Menu:sonata_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'vtally.admin.constituency' service.
     *
     * @return \VtallyBundle\Admin\ConstituencyAdmin A VtallyBundle\Admin\ConstituencyAdmin instance.
     */
    protected function getVtally_Admin_ConstituencyService()
    {
        $instance = new \VtallyBundle\Admin\ConstituencyAdmin('vtally.admin.constituency', 'VtallyBundle\\Entity\\Constituency', 'VtallyBundle:ConstituencyAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('Constituency');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'SonataAdminBundle:Menu:sonata_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'vtally.admin.polling_station' service.
     *
     * @return \VtallyBundle\Admin\PollingStationAdmin A VtallyBundle\Admin\PollingStationAdmin instance.
     */
    protected function getVtally_Admin_PollingStationService()
    {
        $instance = new \VtallyBundle\Admin\PollingStationAdmin('vtally.admin.polling_station', 'VtallyBundle\\Entity\\PollingStation', 'VtallyBundle:PollingStationAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('PollingStation');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'SonataAdminBundle:Menu:sonata_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'vtally.admin.region' service.
     *
     * @return \VtallyBundle\Admin\RegionAdmin A VtallyBundle\Admin\RegionAdmin instance.
     */
    protected function getVtally_Admin_RegionService()
    {
        $instance = new \VtallyBundle\Admin\RegionAdmin('vtally.admin.region', 'VtallyBundle\\Entity\\Region', 'VtallyBundle:RegionAdmin');
    ...
    /**
     * Gets the 'vtally.admin.returning_officer' service.
     *
     * @return \VtallyBundle\Admin\ReturningOfficerAdmin A VtallyBundle\Admin\ReturningOfficerAdmin instance.
     */
    protected function getVtally_Admin_ReturningOfficerService()
    {
        $instance = new \VtallyBundle\Admin\ReturningOfficerAdmin('vtally.admin.returning_officer', 'VtallyBundle\\Entity\\ReturningOfficer', 'VtallyBundle:ReturningOfficerAdmin');
        ...
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setPagerType('default');
        $instance->setLabel('Returning Officer');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'knp_menu_template' => 'SonataAdminBundle:Menu:sonata_menu.html.twig', 'outer_list_rows_mosaic' => 'SonataAdminBundle:CRUD:list_outer_rows_mosaic.html.twig', 'outer_list_rows_list' => 'SonataAdminBundle:CRUD:list_outer_rows_list.html.twig', 'outer_list_rows_tree' => 'SonataAdminBundle:CRUD:list_outer_rows_tree.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'EXPORT' => array(0 => 'EXPORT'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'vtally.admin.setting' service.
     *
     * @return \VtallyBundle\Admin\SettingAdmin A VtallyBundle\Admin\SettingAdmin instance.
     */
    protected function getVtally_Admin_SettingService()
    {
        $instance = new \VtallyBundle\Admin\SettingAdmin('vtally.admin.setting', 'VtallyBundle\\Entity\\Setting', 'VtallyBundle:SettingAdmin');
    ...
    /**
     * Gets the 'vtally.statistic_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \VtallyBundle\Component\StatisticHandler A VtallyBundle\Component\StatisticHandler instance.
     */
    protected function getVtally_StatisticHandlerService()
    {
        return $this->services['vtally.statistic_handler'] = new \VtallyBundle\Component\StatisticHandler($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_POLLING_STATION_READER' => array(0 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_LIST', 1 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_VIEW'), 'ROLE_POLLING_STATION_EDITOR' => array(0 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_CREATE', 1 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_EDIT', 2 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_DELETE', 3 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_EXPORT'), 'ROLE_CONSTITUENCY_READER' => array(0 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_LIST', 1 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_VIEW'), 'ROLE_CONSTITUENCY_EDITOR' => array(0 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_CREATE', 1 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_EDIT', 2 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_DELETE', 3 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_EXPORT'), 'ROLE_COLLATION_CENTER_READER' => array(0 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_LIST', 1 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_VIEW'), 'ROLE_COLLATION_CENTER_EDITOR' => array(0 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_CREATE', 1 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_EDIT', 2 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_DELETE', 3 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_EXPORT'), 'ROLE_RETURNING_OFFICER_READER' => array(0 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_LIST', 1 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_VIEW'), 'ROLE_RETURNING_OFFICER_EDITOR' => array(0 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_CREATE', 1 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_EDIT', 2 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_DELETE', 3 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_EXPORT'), 'ROLE_PR_PARTY_READER' => array(0 => 'ROLE_PR_ADMIN_PR_PARTY_LIST', 1 => 'ROLE_PR_ADMIN_PR_PARTY_VIEW'), 'ROLE_PR_PARTY_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_PARTY_CREATE', 1 => 'ROLE_PR_ADMIN_PR_PARTY_EDIT', 2 => 'ROLE_PR_ADMIN_PR_PARTY_DELETE', 3 => 'ROLE_PR_ADMIN_PR_PARTY_EXPORT'), 'ROLE_PA_PARTY_READER' => array(0 => 'ROLE_PA_ADMIN_PA_PARTY_LIST', 1 => 'ROLE_PA_ADMIN_PA_PARTY_VIEW'), 'ROLE_PA_PARTY_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_PARTY_CREATE', 1 => 'ROLE_PA_ADMIN_PA_PARTY_EDIT', 2 => 'ROLE_PA_ADMIN_PA_PARTY_DELETE', 3 => 'ROLE_PA_ADMIN_PA_PARTY_EXPORT'), 'ROLE_PA_FOOT_PRINT_READER' => array(0 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_LIST', 1 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_VIEW'), 'ROLE_PA_FOOT_PRINT_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_CREATE', 1 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_EDIT', 2 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_DELETE', 3 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_EXPORT'), 'ROLE_PR_FOOT_PRINT_READER' => array(0 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_LIST', 1 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_VIEW'), 'ROLE_PR_FOOT_PRINT_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_CREATE', 1 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_EDIT', 2 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_DELETE', 3 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_EXPORT'), 'ROLE_PR_VOTE_CAST_READER' => array(0 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_LIST', 1 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_VIEW'), 'ROLE_PR_VOTE_CAST_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_CREATE', 1 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_EDIT', 2 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_DELETE', 3 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_EXPORT'), 'ROLE_PR_NOTIFICATION_READER' => array(0 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_LIST', 1 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_VIEW'), 'ROLE_PR_NOTIFICATION_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_CREATE', 1 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_EDIT', 2 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_DELETE', 3 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_EXPORT'), 'ROLE_PA_NOTIFICATION_READER' => array(0 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_LIST', 1 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_VIEW'), 'ROLE_PA_NOTIFICATION_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_CREATE', 1 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_EDIT', 2 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_DELETE', 3 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_EXPORT'), 'ROLE_PR_COMPLAINT_READER' => array(0 => 'ROLE_PR_ADMIN_PR_COMPLAINT_LIST', 1 => 'ROLE_PR_ADMIN_PR_COMPLAINT_VIEW'), 'ROLE_PR_COMPLAINT_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_COMPLAINT_CREATE', 1 => 'ROLE_PR_ADMIN_PR_COMPLAINT_EDIT', 2 => 'ROLE_PR_ADMIN_PR_COMPLAINT_DELETE', 3 => 'ROLE_PR_ADMIN_PR_COMPLAINT_EXPORT'), 'ROLE_PA_COMPLAINT_READER' => array(0 => 'ROLE_PA_ADMIN_PA_COMPLAINT_LIST', 1 => 'ROLE_PA_ADMIN_PA_COMPLAINT_VIEW'), 'ROLE_PA_COMPLAINT_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_COMPLAINT_CREATE', 1 => 'ROLE_PA_ADMIN_PA_COMPLAINT_EDIT', 2 => 'ROLE_PA_ADMIN_PA_COMPLAINT_DELETE', 3 => 'ROLE_PA_ADMIN_PA_COMPLAINT_EXPORT'), 'ROLE_PR_PINK_SHEET_READER' => array(0 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_LIST', 1 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_VIEW'), 'ROLE_PR_PINK_SHEET_EDITOR' => array(0 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_CREATE', 1 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_EDIT', 2 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_DELETE', 3 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_EXPORT'), 'ROLE_PA_PINK_SHEET_READER' => array(0 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_LIST', 1 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_VIEW'), 'ROLE_PA_PINK_SHEET_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_CREATE', 1 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_EDIT', 2 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_DELETE', 3 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_EXPORT'), 'ROLE_PA_VOTE_CAST_READER' => array(0 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_LIST', 1 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_VIEW'), 'ROLE_PA_VOTE_CAST_EDITOR' => array(0 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_CREATE', 1 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_EDIT', 2 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_DELETE', 3 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_EXPORT'), 'ROLE_REGION_READER' => array(0 => 'ROLE_VTALLY_ADMIN_REGION_LIST', 1 => 'ROLE_VTALLY_ADMIN_REGION_VIEW'), 'ROLE_REGION_EDITOR' => array(0 => 'ROLE_VTALLY_ADMIN_REGION_CREATE', 1 => 'ROLE_VTALLY_ADMIN_REGION_EDIT', 2 => 'ROLE_VTALLY_ADMIN_REGION_DELETE', 3 => 'ROLE_VTALLY_ADMIN_REGION_EXPORT'), 'ROLE_USER_READER' => array(0 => 'ROLE_USER_ADMIN_USER_LIST', 1 => 'ROLE_USER_ADMIN_USER_VIEW'), 'ROLE_USER_EDITOR' => array(0 => 'ROLE_USER_ADMIN_USER_CREATE', 1 => 'ROLE_USER_ADMIN_USER_EDIT', 2 => 'ROLE_USER_ADMIN_USER_DELETE', 3 => 'ROLE_USER_ADMIN_USER_EXPORT'), 'ROLE_MANAGER' => array(0 => 'ROLE_POLLING_STATION_READER', 1 => 'ROLE_POLLING_STATION_EDITOR', 2 => 'ROLE_USER_READER', 3 => 'ROLE_USER_EDITOR', 4 => 'ROLE_CONSTITUENCY_READER', 5 => 'ROLE_CONSTITUENCY_EDITOR', 6 => 'ROLE_REGION_READER', 7 => 'ROLE_REGION_EDITOR', 8 => 'ROLE_COLLATION_CENTER_READER', 9 => 'ROLE_COLLATION_CENTER_EDITOR', 10 => 'ROLE_RETURNING_OFFICER_READER', 11 => 'ROLE_RETURNING_OFFICER_EDITOR', 12 => 'ROLE_PR_PARTY_READER', 13 => 'ROLE_PR_PARTY_EDITOR', 14 => 'ROLE_PA_PARTY_READER', 15 => 'ROLE_PA_PARTY_EDITOR', 16 => 'ROLE_PA_FOOT_PRINT_READER', 17 => 'ROLE_PA_FOOT_PRINT_EDITOR', 18 => 'ROLE_PR_FOOT_PRINT_READER', 19 => 'ROLE_PR_FOOT_PRINT_EDITOR', 20 => 'ROLE_PR_VOTE_CAST_READER', 21 => 'ROLE_PR_VOTE_CAST_EDITOR', 22 => 'ROLE_PA_VOTE_CAST_READER', 23 => 'ROLE_PA_VOTE_CAST_EDITOR', 24 => 'ROLE_PR_NOTIFICATION_READER', 25 => 'ROLE_PR_NOTIFICATION_EDITOR', 26 => 'ROLE_PA_NOTIFICATION_READER', 27 => 'ROLE_PA_NOTIFICATION_EDITOR', 28 => 'ROLE_PR_COMPLAINT_READER', 29 => 'ROLE_PR_COMPLAINT_EDITOR', 30 => 'ROLE_PA_COMPLAINT_READER', 31 => 'ROLE_PA_COMPLAINT_EDITOR', 32 => 'ROLE_PR_PINK_SHEET_READER', 33 => 'ROLE_PR_PINK_SHEET_EDITOR', 34 => 'ROLE_PA_PINK_SHEET_READER', 35 => 'ROLE_PA_PINK_SHEET_EDITOR'), 'ROLE_ADMIN' => array(0 => 'ROLE_MANAGER', 1 => 'ROLE_THIRD_PARTY', 2 => 'ROLE_VERIFIER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_ALLOW_SWITCH' => array(0 => 'ROLE_SUPER_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VtallyBundle' => 'VtallyBundle\\VtallyBundle',
                'PrBundle' => 'PrBundle\\PrBundle',
            ...
            'secret' => 'cffb392d8bf4a86b9b1b8430fade19b873ad6971',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'cffb392d8bf4a86b9b1b8430fade19b873ad6971',
            ...
            'security.role_hierarchy.roles' => array(
                'ROLE_POLLING_STATION_READER' => array(
                    0 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_LIST',
                    1 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_VIEW',
                ),
                'ROLE_POLLING_STATION_EDITOR' => array(
                    0 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_CREATE',
                    1 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_EDIT',
                    2 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_DELETE',
                    3 => 'ROLE_VTALLY_ADMIN_POLLING_STATION_EXPORT',
                ),
                'ROLE_CONSTITUENCY_READER' => array(
                    0 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_LIST',
                    1 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_VIEW',
                ),
                'ROLE_CONSTITUENCY_EDITOR' => array(
                    0 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_CREATE',
                    1 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_EDIT',
                    2 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_DELETE',
                    3 => 'ROLE_VTALLY_ADMIN_CONSTITUENCY_EXPORT',
                ),
                'ROLE_COLLATION_CENTER_READER' => array(
                    0 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_LIST',
                    1 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_VIEW',
                ),
                'ROLE_COLLATION_CENTER_EDITOR' => array(
                    0 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_CREATE',
                    1 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_EDIT',
                    2 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_DELETE',
                    3 => 'ROLE_VTALLY_ADMIN_COLLATION_CENTER_EXPORT',
                ),
                'ROLE_RETURNING_OFFICER_READER' => array(
                    0 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_LIST',
                    1 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_VIEW',
                ),
                'ROLE_RETURNING_OFFICER_EDITOR' => array(
                    0 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_CREATE',
                    1 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_EDIT',
                    2 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_DELETE',
                    3 => 'ROLE_VTALLY_ADMIN_RETURNING_OFFICER_EXPORT',
                ),
                'ROLE_PR_PARTY_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_PARTY_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_PARTY_VIEW',
                ),
                'ROLE_PR_PARTY_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_PARTY_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_PARTY_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_PARTY_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_PARTY_EXPORT',
                ),
                'ROLE_PA_PARTY_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_PARTY_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_PARTY_VIEW',
                ),
                'ROLE_PA_PARTY_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_PARTY_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_PARTY_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_PARTY_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_PARTY_EXPORT',
                ),
                'ROLE_PA_FOOT_PRINT_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_VIEW',
                ),
                'ROLE_PA_FOOT_PRINT_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_FOOT_PRINT_EXPORT',
                ),
                'ROLE_PR_FOOT_PRINT_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_VIEW',
                ),
                'ROLE_PR_FOOT_PRINT_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_FOOT_PRINT_EXPORT',
                ),
                'ROLE_PR_VOTE_CAST_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_VIEW',
                ),
                'ROLE_PR_VOTE_CAST_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_VOTE_CAST_EXPORT',
                ),
                'ROLE_PR_NOTIFICATION_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_VIEW',
                ),
                'ROLE_PR_NOTIFICATION_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_NOTIFICATION_EXPORT',
                ),
                'ROLE_PA_NOTIFICATION_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_VIEW',
                ),
                'ROLE_PA_NOTIFICATION_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_NOTIFICATION_EXPORT',
                ),
                'ROLE_PR_COMPLAINT_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_COMPLAINT_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_COMPLAINT_VIEW',
                ),
                'ROLE_PR_COMPLAINT_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_COMPLAINT_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_COMPLAINT_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_COMPLAINT_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_COMPLAINT_EXPORT',
                ),
                'ROLE_PA_COMPLAINT_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_COMPLAINT_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_COMPLAINT_VIEW',
                ),
                'ROLE_PA_COMPLAINT_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_COMPLAINT_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_COMPLAINT_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_COMPLAINT_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_COMPLAINT_EXPORT',
                ),
                'ROLE_PR_PINK_SHEET_READER' => array(
                    0 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_LIST',
                    1 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_VIEW',
                ),
                'ROLE_PR_PINK_SHEET_EDITOR' => array(
                    0 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_CREATE',
                    1 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_EDIT',
                    2 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_DELETE',
                    3 => 'ROLE_PR_ADMIN_PR_PINK_SHEET_EXPORT',
                ),
                'ROLE_PA_PINK_SHEET_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_VIEW',
                ),
                'ROLE_PA_PINK_SHEET_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_PINK_SHEET_EXPORT',
                ),
                'ROLE_PA_VOTE_CAST_READER' => array(
                    0 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_LIST',
                    1 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_VIEW',
                ),
                'ROLE_PA_VOTE_CAST_EDITOR' => array(
                    0 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_CREATE',
                    1 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_EDIT',
                    2 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_DELETE',
                    3 => 'ROLE_PA_ADMIN_PA_VOTE_CAST_EXPORT',
                ),
                'ROLE_REGION_READER' => array(
                    0 => 'ROLE_VTALLY_ADMIN_REGION_LIST',
                    1 => 'ROLE_VTALLY_ADMIN_REGION_VIEW',
                ),
                'ROLE_REGION_EDITOR' => array(
                    0 => 'ROLE_VTALLY_ADMIN_REGION_CREATE',
                    1 => 'ROLE_VTALLY_ADMIN_REGION_EDIT',
                    2 => 'ROLE_VTALLY_ADMIN_REGION_DELETE',
                    3 => 'ROLE_VTALLY_ADMIN_REGION_EXPORT',
                ),
                'ROLE_USER_READER' => array(
                    0 => 'ROLE_USER_ADMIN_USER_LIST',
                    1 => 'ROLE_USER_ADMIN_USER_VIEW',
                ),
                'ROLE_USER_EDITOR' => array(
                    0 => 'ROLE_USER_ADMIN_USER_CREATE',
                    1 => 'ROLE_USER_ADMIN_USER_EDIT',
                    2 => 'ROLE_USER_ADMIN_USER_DELETE',
                    3 => 'ROLE_USER_ADMIN_USER_EXPORT',
                ),
                'ROLE_MANAGER' => array(
                    0 => 'ROLE_POLLING_STATION_READER',
                    1 => 'ROLE_POLLING_STATION_EDITOR',
                    2 => 'ROLE_USER_READER',
                    3 => 'ROLE_USER_EDITOR',
                    4 => 'ROLE_CONSTITUENCY_READER',
                    5 => 'ROLE_CONSTITUENCY_EDITOR',
                    6 => 'ROLE_REGION_READER',
                    7 => 'ROLE_REGION_EDITOR',
                    8 => 'ROLE_COLLATION_CENTER_READER',
                    9 => 'ROLE_COLLATION_CENTER_EDITOR',
                    10 => 'ROLE_RETURNING_OFFICER_READER',
                    11 => 'ROLE_RETURNING_OFFICER_EDITOR',
                    12 => 'ROLE_PR_PARTY_READER',
                    13 => 'ROLE_PR_PARTY_EDITOR',
                    14 => 'ROLE_PA_PARTY_READER',
                    15 => 'ROLE_PA_PARTY_EDITOR',
                    16 => 'ROLE_PA_FOOT_PRINT_READER',
                    17 => 'ROLE_PA_FOOT_PRINT_EDITOR',
                    18 => 'ROLE_PR_FOOT_PRINT_READER',
                    19 => 'ROLE_PR_FOOT_PRINT_EDITOR',
                    20 => 'ROLE_PR_VOTE_CAST_READER',
                    21 => 'ROLE_PR_VOTE_CAST_EDITOR',
                    22 => 'ROLE_PA_VOTE_CAST_READER',
                    23 => 'ROLE_PA_VOTE_CAST_EDITOR',
                    24 => 'ROLE_PR_NOTIFICATION_READER',
                    25 => 'ROLE_PR_NOTIFICATION_EDITOR',
                    26 => 'ROLE_PA_NOTIFICATION_READER',
                    27 => 'ROLE_PA_NOTIFICATION_EDITOR',
                    28 => 'ROLE_PR_COMPLAINT_READER',
                    29 => 'ROLE_PR_COMPLAINT_EDITOR',
                    30 => 'ROLE_PA_COMPLAINT_READER',
                    31 => 'ROLE_PA_COMPLAINT_EDITOR',
                    32 => 'ROLE_PR_PINK_SHEET_READER',
                    33 => 'ROLE_PR_PINK_SHEET_EDITOR',
                    34 => 'ROLE_PA_PINK_SHEET_READER',
                    35 => 'ROLE_PA_PINK_SHEET_EDITOR',
                ),
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_MANAGER',
                    1 => 'ROLE_THIRD_PARTY',
            ...
            'sonata.core.form.types' => array(
                ...
                61 => 'fos_user.username_form_type',
                62 => 'fos_user.profile.form.type',
                63 => 'fos_user.registration.form.type',
                64 => 'fos_user.change_password.form.type',
                65 => 'fos_user.resetting.form.type',
            ),
