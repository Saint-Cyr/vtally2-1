 ...
 */
class PrPinkSheet extends \PrBundle\Entity\PrPinkSheet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrBundle\\Entity\\PrPinkSheet' . "\0" . 'id', '' . "\0" . 'PrBundle\\Entity\\PrPinkSheet' . "\0" . 'name', '' . "\0" . 'PrBundle\\Entity\\PrPinkSheet' . "\0" . 'edited', '' . "\0" . 'PrBundle\\Entity\\PrPinkSheet' . "\0" . 'pollingStation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrPinkSheet $proxy) {
