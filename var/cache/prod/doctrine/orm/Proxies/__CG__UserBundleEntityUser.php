...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'type', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'address', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
