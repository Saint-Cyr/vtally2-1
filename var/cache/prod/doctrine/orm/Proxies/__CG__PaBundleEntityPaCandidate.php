 ...
 */
class PaCandidate extends \PaBundle\Entity\PaCandidate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PaBundle\\Entity\\PaCandidate' . "\0" . 'id', '' . "\0" . 'PaBundle\\Entity\\PaCandidate' . "\0" . 'name', '' . "\0" . 'PaBundle\\Entity\\PaCandidate' . "\0" . 'paVoteCasts', '' . "\0" . 'PaBundle\\Entity\\PaCandidate' . "\0" . 'paParty', '' . "\0" . 'PaBundle\\Entity\\PaCandidate' . "\0" . 'constituency'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaCandidate $proxy) {
    ...
    public function setPaParty(\PaBundle\Entity\PaParty $paParty)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPaParty', [$paParty]);

        return parent::setPaParty($paParty);
    }
    ...
    public function getPaParty()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPaParty', []);

        return parent::getPaParty();
    }
