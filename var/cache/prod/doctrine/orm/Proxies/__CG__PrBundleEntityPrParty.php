 ...
 */
class PrParty extends \PrBundle\Entity\PrParty implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrBundle\\Entity\\PrParty' . "\0" . 'id', '' . "\0" . 'PrBundle\\Entity\\PrParty' . "\0" . 'name', '' . "\0" . 'PrBundle\\Entity\\PrParty' . "\0" . 'candidate', '' . "\0" . 'PrBundle\\Entity\\PrParty' . "\0" . 'prVoteCasts'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrParty $proxy) {
