 ...
 */
class PaPinkSheet extends \PaBundle\Entity\PaPinkSheet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PaBundle\\Entity\\PaPinkSheet' . "\0" . 'id', '' . "\0" . 'PaBundle\\Entity\\PaPinkSheet' . "\0" . 'name', '' . "\0" . 'PaBundle\\Entity\\PaPinkSheet' . "\0" . 'edited', '' . "\0" . 'PaBundle\\Entity\\PaPinkSheet' . "\0" . 'pollingStation'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaPinkSheet $proxy) {
