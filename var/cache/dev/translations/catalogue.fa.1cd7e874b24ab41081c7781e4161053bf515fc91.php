...
$catalogue = new MessageCatalogue('fa', array (
  ...
  array (
    ...
    'btn_update_acl' => 'به روز رسانی دسترسی',
    'flash_acl_edit_success' => 'دسترسی به روز رسانی شد',
    'link_action_acl' => 'دسترسی',
    'short_object_description_placeholder' => 'دسترسی',
    'title_search_results' => 'نتایج جستجو',
    'search_placeholder' => 'جستجو',
    'no_results_found' => 'نتیجه ای در برنداشت',
    'add_new_entry' => 'افزودن',
    'link_actions' => 'اقدامات',
    'noscript_warning' => 'اسکریپ فعال نمی باشد',
    'message_form_group_empty' => 'گروه نمی تواند خالی باشد',
