 ...
 */
class CollationCenter extends \VtallyBundle\Entity\CollationCenter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'VtallyBundle\\Entity\\CollationCenter' . "\0" . 'id', '' . "\0" . 'VtallyBundle\\Entity\\CollationCenter' . "\0" . 'name', '' . "\0" . 'VtallyBundle\\Entity\\CollationCenter' . "\0" . 'returningOfficer', '' . "\0" . 'VtallyBundle\\Entity\\CollationCenter' . "\0" . 'constituency'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CollationCenter $proxy) {
